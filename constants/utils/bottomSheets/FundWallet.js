...
const FundWalletTransaction = ({refRBSheetForm, refRBSheet}) => {
  return (
    <View style={[styles.container, {paddingTop: 60}]}>
      <Text style={[styles.mediumTxt, {fontSize: SIZES.xxl}]}>Fund wallet</Text>

      <Text style={[styles.smallTxt, {marginTop: 20}]}>
        Enter an amount and select a source to fund your wallet
      </Text>
...
const FundWallet = ({refRBSheetForm, refRBSheet}) => {
      ...
      <RBSheet
        ...
        <View style={[styles.exchangeIcon, {top: 10, right: 10}]}>
          <Icon
            ...
            size={25}
            color={COLORS.light.primary}
            onPress={() => refRBSheetForm.current.close()}
          />
        </View>
